...
4) The code [[adding_Genus_Species_data_in_metadata_files.R]] crunches the metadata and adds a column for genus and species. We also add Family data using taxize package. Other data related to taxize can be added as well if the user wants.
