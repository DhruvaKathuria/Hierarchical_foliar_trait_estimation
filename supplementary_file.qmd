...
![Decrease in the root mean squared error between the full model and the reduced model as we add more wavelengths to the full model. The horizontal line at 0 represents the step where adding more wavelengths results in similar predictive accuracy between the full model and submodel according to the cross-validation root mean squared error. The bars represents one standard deviation in rmse for cross validation errors](paper_draft/figures/wavelength_selection_all_covariates.png)
