...
@fig-posterior_parameters_full_model shows the posterior parameter distribution histograms of the five wavelengths with largest absolute mean value for the regression coefficients.
<!-- [Alexey] Are these coefficients for one particular trait (and if so, which one)? Or for all the traits? I would expect different wavelengths to be most important for different traits. -->
