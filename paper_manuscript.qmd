...
In our case, we will use the posterior projection to determine the complexity (i.e the number of input wavelengths to be used) of our linear spectral model.
...
![Most important spectra for each of the traits](paper_draft/figures/spectra_importance_2.png){#fig-spectra_importance_2}
