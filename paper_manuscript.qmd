...
The observations used for training the models span a wide range of climatic zones and biomes (@fig-studyarea). The three traits were also chosen because the number of training observations varies significantly across the three traits (Car~A~: 394, N~M~: 541, LMA: 5,934), which helps demonstrate the algorithm's accuracy across different training set sizes.
