...
As mentioned in @sec-methods_posterior_projection, the reduced model finds a minimal subset of wavelengths (which are not necessarily unique) such that adding more wavelengths to the model will not lead to a significant increase in the predictive accuracy when compared with the full model. We can still use @fig-spectra_importance, to identify the VSWIR regions that are important for predicting a particular trait. For carotenoid, the red-edge (add citation) region comprises the most important wavelength, along with a cluster of sensitive wavelength from 1150 nm - 1300 nm. Carotenoid also has some important wavelengths in the visible spectrum (500 nm - 650 nm) and in the SWIR region (1300 nm - 2500 nm). For nitrogen, the red-edge again comprises the most important wavelength with the rest of the important wavelengths clustered around the region 1400 nm - 1900 nm and some wavelengths in the NIR and 2000-2500 nm region.
