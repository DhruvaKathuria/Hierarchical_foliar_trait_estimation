...
Before interpreting the results, a sometimes overlooked implicit assumption is that the important wavelengths selected by any algorithm is dependent on the assumpations of the underlying model. A Bayesian approach is helpful in this regard as we make explicit assumptions about our prior beliefs, and the underlying trait distribution (including quantifying measurement errors). This helps us to make wavelength selection claims only under the fixed assumptions. For example, in this paper, we did not account for important effect of climate, different land surface conditions, leaf health, across and within trait variation within plant functional types, site-specific measurement errors etc. on traits and assumed only the marginal effects of spectra on traits. This can cause latent effects of these covariates in certain wavelengths shown to be important. A Bayesian model incorporating some or all of these covariates in addition to spectra, might give different results for important spectra. It is always usefult to keep this distinction in mind.

For carotenoid, the red-edge (add citation) region comprises the most important wavelength, along with moderately important wavelengths in the visible spectrum which is in line with previous research . Additionally, we find a cluster of sensitive wavelength in the NIR from 1150 nm - 1300 nm around a known secondary water-absorption band at 1240 nm [@ustin2020] and some wavelengths in the SWIR region (1300 nm - 2500 nm). The leaf reflectance spectra in the SWIR region is sensitive to water absorption, leaf structure and dry matter content [@ustin2020, @serbinArcticTropicsMultibiome2019]. Carotenoid has been shown to be change with leaf growth stage and is affected by water stress [@mibei2016] potentially explaining the sensitivity of the above wavelengths to carotenoid.

In this paper, we have not distinguished between the different sources of variation that can exist in leavesvarious form of leaves, for example healthy leaves vs non healthy leaves, top of canopy vs bottom of canopy etc, so these factors might influence these results. For example, carotenoid has been shown to be affected by drought stress, so this might be one of the reasons that we are seeing an affect of spectra beyond the visible spectrum on carotenoid as they are indirectly affecting the carotenoid content of the leaves.

For nitrogen, the red-edge again comprises the most important wavelength with the rest of the important wavelengths clustered around the region 1400 nm - 1900 nm and 2000-2500 nm in the SWIR region. The water absorption band at 1240 nm again has some moderately important wavelengths indicating the effect of other ancillary factors in nitrogen prediction.

For LMA, the SWIR region is the most important region for predicting LMA which is in line with previous findings. The two most important wavelengths fall in the 2000 - 2500 nm region, while a cluster of important wavelengths fall in the 1500-2000 nm region. The NIR region is also useful in predicting LMA which is line with the findings of [@serbinArcticTropicsMultibiome2019].
