...
{
  pls_object = readRDS(file.path(data_folder, "data", "code_output_data", "plsr_files", str_glue("{trait_name1}_LOO_PLSR_object_March_2026.rds")))
  ...
  vip_scores = VIP(pls_object, opt.comp = index1_min)
