...
# Metadata related to traits ----------------------------------------------

#For now I am making a database of the commonly used trait names in the datasets used in ECOSIS
LMA_vector = c("lma", 
               "leaf_mass_per_area", 
               "leaf mass per area")
Chl_vector = c("chlorophyll", 
               "chl", 
               "chl_ab", 
               "chlab") # work on how to separate chla and chlb from chltot
Chla_vector = c("chla", 
                "chl_a", 
                "chlb", 
                "chl_b", 
...
exact_vector_list_for_covariate_first_pass_list = list("Carotenoid_Area" =  c("car", 
                                                                              "car_area", 
                                                                              "car_area (ug/cm2)", 
                                                                              "carot_tot_area_l", 
                                                                              "carotenoid ( g/cm )", 
                                                                              "carotenoid (µg/cm²)", 
                                                                              "carotenoid content ( g/cm )", 
                                                                              "carotenoids"),
                                                       "LMA" = c("lma_gdw_m2", 
                                                                 "lma g m2", 
                                                                 "lma", 
                                                                 "leaf mass per area", 
                                                                 "lma_g_m2", 
                                                                 "leaf mass per area (g/cm )", 
                                                                 "lma_gm2", "leaf mass per area (g/cm²)",
                                                                 "leaf mass per area (mg/cm2)", 
                                                                 "lma_gdw_m2", 
                                                                 "leaf mass per area (mg/cm2)", 
                                                                 "leaf mass per area (g/cm2)"),
                                                       "Nitrogen" = c("nmass_percent", 
                                                                      "n", 
                                                                      "nmass", 
                                                                      "leaf nitrogen content per leaf area (% dm)", 
                                                                      "nitrogen", "nitrogen (mg/g)", 
                                                                      "leaf nitrogen content per leaf dry mass (% dw)", 
                                                                      "nitrogen_percent", 
                                                                      "n_mass_g_g", 
...
# this is subsetting by eye the output of above which has more than one matching dataset for the above. 
# Used for choosing one item only for multi-item datasets. The second pass is imp for example for 
# separating trait_area from trait_mass or chl_a from chl_tot
exact_vector_list_for_covariate_second_pass_list = list("Carotenoid_Area" = c("car_area", 
                                                                              "carotenoid content ( g/cm )", 
                                                                              "carot_tot_area_l", 
                                                                              "car_area (ug/cm2)"),
                                                        "LMA" = exact_vector_list_for_covariate_first_pass_list[["LMA"]],
                                                        "Nitrogen" = exact_vector_list_for_covariate_first_pass_list[["Nitrogen"]])
