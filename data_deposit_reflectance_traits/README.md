...
| `data/​Species_​data/​Species_​attribute_​data_​Dhruva.csv` | Earlier/intermediate growth-form/phenology/leaf-type lookup table, populated and appended to by `get_​growth_​form_​phenology_​leaf_​type_​etc_​from_​Wiki.R` which uses Wikipedia scraping. It was further filled by searching online, and using the assistance of large language models. |
